...
type TrainerNotificationsPageProps = {
  searchParams: Promise<{ page?: string }>;
};

export default async function TrainerNotificationsPage({ searchParams }: TrainerNotificationsPageProps) {
  ...
  return (
    <NotificationsPageClient
      ...
      pageSize={PAGE_SIZE}
      listBasePath="/trainer/notifications"
      calendarHref="/trainer/calendar"
    />
  );
}
