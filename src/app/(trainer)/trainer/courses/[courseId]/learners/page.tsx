  ...
  return (
    <section className="space-y-6">
      <div className="space-y-2">
        ...
        <h2 className="text-2xl font-bold text-[var(--color-text-dark)]">Apprenants inscrits</h2>
      ...
      {course.enrollments.length ? (
        <div className="overflow-hidden rounded-2xl border border-[var(--color-text-dark)]/10 bg-white shadow-sm">
          <table className="min-w-full divide-y divide-[#0c0910]/10 text-sm">
            <thead className="bg-[var(--color-surface-high)] text-left text-xs uppercase tracking-[0.08em] text-[var(--color-text-dark)]/58">
              <tr>
                  ...
                  <td className="px-4 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="truncate text-xs text-[var(--color-text-dark)]/60">{enrollment.user.email}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-4 py-4 text-[var(--color-text-dark)]/70">{formatDate(enrollment.enrolledAt)}</td>
                  <td className="px-4 py-4">
                    <div className="space-y-1">
                      <div className="flex items-center justify-between text-xs font-medium text-[var(--color-text-dark)]/70">
                        <span>Avancement</span>
                        <span>{enrollment.progressPercent}%</span>
                      </div>
                      <div className="rounded-[1.25rem] bg-[var(--color-surface-low)] p-1">
                        <div
        ...
        <div className="rounded-2xl border border-dashed border-[var(--color-text-dark)]/20 bg-white px-6 py-10 text-center">
          <h3 className="text-lg font-semibold text-[var(--color-text-dark)]">Aucun apprenant inscrit</h3>
