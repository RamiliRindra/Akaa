    ...
    <section className="space-y-8">
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.1fr)_360px] xl:items-start">
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <h2 className="font-display text-3xl font-black tracking-tight text-[var(--color-text)] sm:text-5xl">
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3">
                <div className="panel-card flex items-center gap-3 p-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[var(--color-text)]">{courses.length} cours</p>
                    <p className="text-xs text-[var(--color-text)]/62">Disponibles immédiatement.</p>
                  </div>
                </div>
                <div className="panel-card flex items-center gap-3 p-4">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-[var(--color-text)]">{categories.length} catégories</p>
                    <p className="text-xs text-[var(--color-text)]/62">Pour filtrer selon vos priorités.</p>
                  </div>
                </div>
                <div className="panel-card flex items-center gap-3 p-4">
      ...
      <div className="space-y-3">
        <div>
          ...
          <h3 className="font-display text-2xl font-black text-[var(--color-text)]">Filtrer le catalogue</h3>
        </div>
        <CategoryFilter categories={categories} activeSlug={categorySlug} />
      </div>

      <div className="space-y-2">
        <h3 className="font-display text-2xl font-black text-[var(--color-text)]">Tous les cours publiés</h3>
      ...
      {courses.length ? (
        ...
        <div className="surface-section px-6 py-10 text-center">
          <h3 className="font-display text-2xl font-black text-[var(--color-text)]">Aucun cours publié</h3>
